...
if(USE_MUSL)
    ...
    set(BEARSSL_LIBRARIES "${BEARSSL_LIBRARIES}")
    set(BEARSSL_INCLUDE_DIRS "${BEARSSL_INCLUDE_DIRS}")
    set(BEARSSL_FOUND "${BEARSSL_FOUND}")
    return()
endif()
    ...
    if(WIN32)
        ...
        if(NOT EXISTS "${BEARSSL_LIB}")
            ...
            apply_patch(
                ...
                PATCH_FILE "${CMAKE_SOURCE_DIR}/cmake/deps/patches/bearssl-0-windows-clang.patch"
                PATCH_NUM 0
