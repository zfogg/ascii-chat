...
function(configure_llvm_post_project)
        ...
        if(APPLE AND NOT EXISTS "${CLANG_RESOURCE_DIR}/include/mach-o/dyld.h")
            ...
            if(XCRUN_EXECUTABLE)
                ...
                if(XCODE_SDK_PATH AND EXISTS "${XCODE_SDK_PATH}/usr/include")
                    ...
                    add_compile_options(-isystem ${XCODE_SDK_PATH}/usr/local/include)
                else()
    ...
    if(_need_llvm_libs)
        ...
        if(DETECTED_LLVM_LINK_FLAGS AND (NOT DEFINED ENV{LDFLAGS} OR NOT "$ENV{LDFLAGS}" MATCHES "-L.*llvm"))
            if(NOT CMAKE_EXE_LINKER_FLAGS MATCHES "-lunwind")
                ...
                if(NOT CMAKE_SHARED_LINKER_FLAGS MATCHES "-L.*llvm")
                ...
                message(STATUS "${BoldYellow}${LLVM_SOURCE_NAME}${ColorReset} library paths and -lunwind already present in linker flags")
            endif()
        else()
