...
if(NOT BUILDING_OBJECT_LIBS)
    add_executable(test-static-lib ${CMAKE_SOURCE_DIR}/cmake/test/test_static_lib.c)
...
add_executable(test-shared-lib ${CMAKE_SOURCE_DIR}/cmake/test/test_shared_lib.c)
