...
foreach(SYMBOL ${ALL_SYMBOLS})
    ...
    # - C++ name mangling (?)
    # - Debug symbols (DW.)
    if(NOT SYMBOL MATCHES "^(__imp_|__real[@_]|__xmm@|__ymm@|_?GLOBAL__|DW\\.|_fltused|_tls_|__security|__guard|GS_|_RTC|\\?|^\\.|___|CLSID_|IID_|GUID_|KSPROPERTYSETID_|MFCONNECTOR_|MFATTRIBUTE_|MEDevice|IN6_)")
