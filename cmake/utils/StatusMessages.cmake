...
if(CMAKE_C_COMPILER_LAUNCHER)
    message(STATUS "  Compiler Launcher: ${BoldGreen}${CMAKE_C_COMPILER_LAUNCHER}${ColorReset}")
endif()
message(STATUS "  Compiler ID:       ${BoldCyan}${CMAKE_C_COMPILER_ID}${ColorReset} ${BoldGreen}${CMAKE_C_COMPILER_VERSION}${ColorReset}")
message(STATUS "  Archiver:          ${Cyan}${CMAKE_AR}${ColorReset}")
message(STATUS "  Ranlib:            ${Cyan}${CMAKE_RANLIB}${ColorReset}")
...
message(STATUS "  Build Tool:        ${BoldCyan}${CMAKE_GENERATOR}${ColorReset}")
if(CMAKE_GENERATOR STREQUAL "Ninja")
    message(STATUS "  Build Binary:      ${BoldGreen}ninja${ColorReset}")
elseif(CMAKE_GENERATOR MATCHES "Unix Makefiles")
    if(CMAKE_MAKE_PROGRAM)
        get_filename_component(MAKE_BINARY "${CMAKE_MAKE_PROGRAM}" NAME)
        message(STATUS "  Build Binary:      ${BoldGreen}${MAKE_BINARY}${ColorReset}")
    else()
        message(STATUS "  Build Binary:      ${BoldGreen}make${ColorReset}")
    endif()
elseif(CMAKE_GENERATOR MATCHES "Visual Studio")
    message(STATUS "  Build Binary:      ${BoldGreen}msbuild${ColorReset}")
elseif(CMAKE_GENERATOR MATCHES "Xcode")
    message(STATUS "  Build Binary:      ${BoldGreen}xcodebuild${ColorReset}")
else()
    message(STATUS "  Build Binary:      ${BoldGreen}${CMAKE_GENERATOR}${ColorReset}")
endif()
if(WIN32)
    if(WINDOWS_SDK_VERSION)
        message(STATUS "  Windows SDK:       ${BoldCyan}${WINDOWS_SDK_VERSION}${ColorReset}")
    endif()
...
message(STATUS "  SIMD Mode:         ${BoldCyan}${SIMD_MODE}${ColorReset}")
if(ENABLE_SIMD_SSE2)
