...
if(WIX_EXECUTABLE)
    ...
    if(WIX_MAJOR_VERSION GREATER_EQUAL 4)
        ...
        message(STATUS "${Yellow}CPack:${ColorReset} WiX generator will be enabled using WiX .NET Tools")
    else()
        message(STATUS "${Red}CPack:${ColorReset} WiX version ${WIX_VERSION_OUTPUT} is too old (need v4+)")
        set(WIX_EXECUTABLE "")
    endif()
endif()
