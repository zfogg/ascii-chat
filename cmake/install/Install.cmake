...
#
# The manpage source is in share/man/man1/ascii-chat.1.in and uses @PROJECT_VERSION@ for
# version substitution via the man1 build target.
if(UNIX)
    # Install man pages to share/man/man1/ (section 1 = user commands)
    # Note: Man pages are generated by the 'man1' build target
    install(FILES
        "${CMAKE_BINARY_DIR}/share/man/man1/ascii-chat.1"
        "${CMAKE_BINARY_DIR}/share/man/man1/acds.1"
        DESTINATION share/man/man1
        COMPONENT Runtime
    )
    message(STATUS "${BoldGreen}Configured${ColorReset} manpage installation: ${BoldBlue}ascii-chat.1, acds.1${ColorReset} → ${BoldYellow}share/man/man1/${ColorReset}")
endif()
...
if(UNIX)
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/share/bash-completion/completions/ascii-chat")
        install(FILES "${CMAKE_SOURCE_DIR}/share/bash-completion/completions/ascii-chat"
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/share/zsh/site-functions/_ascii-chat")
        install(FILES "${CMAKE_SOURCE_DIR}/share/zsh/site-functions/_ascii-chat"
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/share/fish/vendor_completions.d/ascii-chat.fish")
        install(FILES "${CMAKE_SOURCE_DIR}/share/fish/vendor_completions.d/ascii-chat.fish"
