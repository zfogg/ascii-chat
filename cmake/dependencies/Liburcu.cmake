...
elseif(UNIX)
    ...
    if(PkgConfig_FOUND)
        pkg_check_modules(LIBURCU QUIET liburcu-mb)
        if(LIBURCU_FOUND)
            message(STATUS "Found liburcu via pkg-config: ${LIBURCU_LIBRARIES}")
            # Create imported target for consistency
            add_library(liburcu INTERFACE IMPORTED GLOBAL)
            target_include_directories(liburcu INTERFACE ${LIBURCU_INCLUDE_DIRS})
            target_link_libraries(liburcu INTERFACE ${LIBURCU_LIBRARIES})
            return()
        endif()
    endif()
