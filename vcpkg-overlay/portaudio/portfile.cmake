# ascii-chat overlay port: portaudio with ALSA support
# The upstream vcpkg port disables ALSA, which breaks device enumeration on Linux.
# This overlay enables ALSA so --list-microphones and --list-speakers work.
...
elseif(VCPKG_TARGET_IS_IOS OR VCPKG_TARGET_IS_OSX)
    ...
    # ascii-chat fix: Enable ALSA for device enumeration on Linux
    # The upstream port uses JACK-only which requires a running JACK server.
    # Most desktop Linux systems use ALSA/PulseAudio, so we enable ALSA.
    vcpkg_list(APPEND options
        -DPA_USE_JACK=OFF
        -DPA_USE_ALSA=ON
    )
