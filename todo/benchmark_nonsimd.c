...
int main() {
    ...
    printf("Testing non-SIMD image_print_colored() with 10x faster string generation\n\n");
    ...
    char *result = image_print_colored(test_image);
    ...
    result = image_print_colored(test_image);
