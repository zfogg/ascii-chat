...
Test(main_integration, server_main_starts_and_stops) {
    ...
    char *argv[] = {
        "ascii-chat-server",
        "--port", port_str,
        "--log-file", "/tmp/test_server_main.log",
        NULL
    };
...
Test(main_integration, server_client_basic_connection) {
    ...
    char *server_argv[] = {
        "ascii-chat-server",
        "--port", port_str,
        "--log-file", "/tmp/test_server_client.log",
        NULL
    };
    ...
    char *client_argv[] = {
        ...
        "--address", "127.0.0.1",
        "--snapshot",
        "--snapshot-delay", "1", // Run for 1 second
...
Test(main_integration, server_multiple_clients_sequential) {
    ...
    char *server_argv[] = {
        "ascii-chat-server",
        "--port", port_str,
        "--log-file", "/tmp/test_multi_seq.log",
        NULL
    };
    ...
    for (int i = 0; i < 3; i++) {
        ...
        char *client_argv[] = {
            ...
            "--address", "127.0.0.1",
            "--snapshot",
            "--log-file", "/tmp/test_client_seq.log",
            NULL
        };
...
Test(main_integration, server_multiple_clients_concurrent) {
    ...
    char *server_argv[] = {
        "ascii-chat-server",
        "--port", port_str,
        "--log-file", "/tmp/test_multi_concurrent.log",
        NULL
    };
    ...
    for (int i = 0; i < 3; i++) {
        ...
        char *client_argv[] = {
            ...
            "--address", "127.0.0.1",
            "--snapshot",
            "--snapshot-delay", delay_str,
            "--log-file", "/tmp/test_client_concurrent.log",
            NULL
        };
...
Test(main_integration, server_client_with_options) {
    ...
    char *server_argv[] = {
        ...
        "--color",
        "--audio",
        "--log-file", "/tmp/test_server_options.log",
        NULL
    };
    ...
    char *client_argv[] = {
        ...
        "--snapshot",
        "--snapshot-delay", "2",
        "--log-file", "/tmp/test_client_options.log",
        NULL
    };
...
Test(main_integration, server_survives_client_crash) {
    ...
    char *server_argv[] = {
        "ascii-chat-server",
        "--port", port_str,
        "--log-file", "/tmp/test_server_survives.log",
        NULL
    };
    ...
    char *client_argv[] = {
        ...
        "--port", port_str,
        "--address", "127.0.0.1",
        "--log-file", "/tmp/test_client_crash.log",
        NULL
    };
    ...
    char *client2_argv[] = {
        ...
        "--address", "127.0.0.1",
        "--snapshot",
        "--log-file", "/tmp/test_client_after_crash.log",
        NULL
    };
