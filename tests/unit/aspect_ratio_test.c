...
TestSuite(aspect_ratio, .init = setup_quiet_test_logging, .fini = restore_test_logging);
...
Test(aspect_ratio, random_values_comprehensive) {
    ...
    for (int i = 0; i < 1000; i++) {
        ...
        cr_assert_gt(out_width, 0, "Random test %d: img_w=%zd, img_h=%zd, term_w=%zd, term_h=%zd, stretch=%d",
                     i, img_w, img_h, term_w, term_h, stretch);
        cr_assert_gt(out_height, 0, "Random test %d: img_w=%zd, img_h=%zd, term_w=%zd, term_h=%zd, stretch=%d",
                     i, img_w, img_h, term_w, term_h, stretch);
...
Test(aspect_ratio2, random_values_comprehensive) {
    ...
    for (int i = 0; i < 1000; i++) {
        ...
        cr_assert_gt(out_width, 0, "Random test %d: img_w=%zd, img_h=%zd, target_w=%zd, target_h=%zd",
                     i, img_w, img_h, target_w, target_h);
        cr_assert_gt(out_height, 0, "Random test %d: img_w=%zd, img_h=%zd, target_w=%zd, target_h=%zd",
                     i, img_w, img_h, target_w, target_h);
...
Test(calculate_fit_dimensions_pixel, random_values_comprehensive) {
    ...
    for (int i = 0; i < 1000; i++) {
        ...
        cr_assert_gt(out_width, 0, "Random test %d: img_w=%d, img_h=%d, max_w=%d, max_h=%d",
                     i, img_w, img_h, max_w, max_h);
        cr_assert_gt(out_height, 0, "Random test %d: img_w=%d, img_h=%d, max_w=%d, max_h=%d",
                     i, img_w, img_h, max_w, max_h);
