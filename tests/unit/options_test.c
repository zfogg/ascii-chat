...
Test(options, valid_color_modes) {
    ...
    char *valid_modes[] = {
        "auto", "mono", "monochrome", "16", "16color",
        "256", "256color", "truecolor", "24bit"
    };
...
Test(options, invalid_palettes) {
    char *invalid_palettes[] = {
        "invalid", "ascii", "unicode", "color", ""
    };
...
Test(options, flag_options) {
    ...
    char *argv[] = {"client", "--show-capabilities", "--utf8", "--audio", "--stretch", "--quiet", "--snapshot", "--encrypt"};
