...
Test(hashtable, basic_remove) {
    ...
    data1->id = 100; strcpy(data1->name, "Item 1");
    data2->id = 200; strcpy(data2->name, "Item 2");
    data3->id = 300; strcpy(data3->name, "Item 3");
...
Test(hashtable, duplicate_key_insert) {
    ...
    data1->id = 123; strcpy(data1->name, "Original");
    data2->id = 123; strcpy(data2->name, "Updated");
