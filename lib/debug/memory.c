...
static const debug_memory_suppression_t g_suppression_config[] = {
    ...
    {.file = "lib/options/colorscheme.c",
     ...
     .key = {0}},
    // Intentional singletons - cleaned up at atexit (before memory report)
    {.file = "lib/util/path.c",
     .line = 1224,
     .expected_count = 1,
     .expected_bytes = 43,
     .reason = "Path normalization singleton (freed at shutdown)",
     .key = {0}},
    {.file = "lib/util/pcre2.c",
     .line = 54,
     .expected_count = 1,
     .expected_bytes = 56,
     .reason = "PCRE2 JIT singleton (freed at atexit)",
     .key = {0}},
    {.file = "lib/util/pcre2.c",
     .line = 62,
     .expected_count = 1,
     .expected_bytes = 102,
     .reason = "PCRE2 mcontext singleton (freed at atexit)",
     .key = {0}},
