...
enum {
  ASCII_INSTR_MACRO_NONE = 0u,
  ASCII_INSTR_MACRO_EXPANSION = 1u,
  ASCII_INSTR_MACRO_INVOCATION = 2u,
};

#if defined(__clang__)
#define ASCII_INSTR_SIGNAL_HANDLER __attribute__((annotate("ASCII_INSTR_SIGNAL_HANDLER")))
#else
#define ASCII_INSTR_SIGNAL_HANDLER
#endif
