...
/**
 * Create a thread with automatic error handling and logging.
 *
 * @param thread_var Thread handle (ascii_thread_t)
 ...
 * Usage:
 * @code
 * THREAD_CREATE_OR_RETURN(g_worker_thread, worker_func, NULL, "Failed to create worker");
 * @endcode
 */
#define THREAD_CREATE_OR_RETURN(thread_var, func, arg, error_msg)                                                        \
  do {                                                                                                                    \
