...
asciichat_error_t completions_generate_zsh(FILE *output) {
  ...
  fprintf(output, "      )\n"
                  ...
                  "\n"
                  "_ascii_chat_args() {\n"
                  "  # Re-dispatch to the proper mode-specific function for completion\n"
                  "  # Note: shift words array to remove the mode name for proper context\n"
                  "  case $words[2] in\n"
