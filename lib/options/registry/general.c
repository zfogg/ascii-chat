...
const registry_entry_t g_general_entries[] = {
    ...
    {"splash-screen",
     ...
     NULL,
     false,
     true, // optional_arg: allows --splash-screen to toggle or --splash-screen=true/false
    ...
    {"no-splash-screen",
     ...
     OPTION_TYPE_BOOL,
     offsetof(options_t, splash_screen),
     &default_splash_false,
     sizeof(bool),
     "Disable splash screen with ASCII art (same as --splash-screen=false).",
     "GENERAL",
     NULL,
     false,
     NULL,
     ...
     NULL,
     false,
     false, // no optional arg for --no-splash-screen
     OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY,
     {0},
     NULL},
    {"status-screen",
     ...
     NULL,
     false,
     true, // optional_arg: allows --status-screen to toggle or --status-screen=true/false
