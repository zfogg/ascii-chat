...
const registry_entry_t g_network_entries[] = {
    ...
    {"websocket-tls-cert",
     '\0',
     OPTION_TYPE_STRING,
     offsetof(options_t, websocket_tls_cert),
     NULL,
     OPTIONS_BUFF_SIZE,
     "WebSocket TLS certificate file path for WSS (secure WebSocket) support (server/discovery-service only).",
     "NETWORK",
     NULL,
     false,
     "ASCII_CHAT_WEBSOCKET_TLS_CERT",
     NULL,
     NULL,
     false,
     false,
    ...
    {"websocket-tls-key",
     '\0',
     OPTION_TYPE_STRING,
     offsetof(options_t, websocket_tls_key),
     NULL,
     OPTIONS_BUFF_SIZE,
     "WebSocket TLS private key file path for WSS (secure WebSocket) support (server/discovery-service only).",
     "NETWORK",
     NULL,
     false,
     "ASCII_CHAT_WEBSOCKET_TLS_KEY",
     NULL,
     NULL,
     false,
     false,
     ...
     {.input_type = OPTION_INPUT_STRING},
     NULL},
    {"websocket-tls-key-password",
     '\0',
     OPTION_TYPE_STRING,
     offsetof(options_t, websocket_tls_key_password),
     NULL,
     OPTIONS_BUFF_SIZE,
     "Password for password-protected WebSocket TLS private key (use ASCII_CHAT_WEBSOCKET_TLS_KEY_PASSWORD env var for "
     "security).",
     "NETWORK",
     NULL,
     false,
     "ASCII_CHAT_WEBSOCKET_TLS_KEY_PASSWORD",
     NULL,
     NULL,
     false,
     false,
    ...
    {"discovery-service-port",
     ...
     NULL,
     false,
     "ASCII_CHAT_DISCOVERY_SERVICE_PORT",
     NULL,
     NULL,
     false,
     false,
    ...
    {"discovery-service-url",
     '\0',
     OPTION_TYPE_STRING,
     offsetof(options_t, discovery_service_url),
     NULL,
     OPTIONS_BUFF_SIZE,
     "Discovery service WebSocket URL (ws:// or wss://). Mutually exclusive with --discovery-service-port.",
     "NETWORK",
     NULL,
     false,
     "ASCII_CHAT_DISCOVERY_SERVICE_URL",
     NULL,
     NULL,
     false,
     false,
