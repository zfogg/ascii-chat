...
static const registry_entry_t g_options_registry[] = {
    ...
    {"encrypt", 'E', OPTION_TYPE_BOOL, offsetof(options_t, encrypt_enabled), &default_encrypt_enabled_value,
     sizeof(bool), "Enable end-to-end encryption (requires other party to run unencrypted or matching --key)",
     "SECURITY", false, "ASCII_CHAT_ENCRYPT", NULL, NULL, false, false,
    ...
    {"no-encrypt", '\0', OPTION_TYPE_BOOL, offsetof(options_t, no_encrypt), &default_no_encrypt_value, sizeof(bool),
     "Disable encryption (inverse of --encrypt)", "SECURITY", false, "ASCII_CHAT_NO_ENCRYPT", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY | OPTION_MODE_DISCOVERY_SVC},
    ...
    {"client-keys", '\0', OPTION_TYPE_STRING, offsetof(options_t, client_keys), "", 0,
     "Allowed client keys (file with one key per line, github:USER, gitlab:USER, gpg:KEYID, or HTTPS URL)", "SECURITY",
     false, "ASCII_CHAT_CLIENT_KEYS", NULL, NULL, false, false,
    ...
    {"discovery-server", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_server),
     OPT_ENDPOINT_DISCOVERY_SERVICE, 0, "Discovery service address for p2p sessions", "NETWORK", false,
