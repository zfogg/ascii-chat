...
static const registry_entry_t g_options_registry[] = {
    ...
    {"verbose", 'V', OPTION_TYPE_CALLBACK, offsetof(options_t, verbose_level), 0, sizeof(unsigned short int),
     "Increase log verbosity (stackable: -VV, -VVV, or --verbose)", "LOGGING", false, "ASCII_CHAT_VERBOSE", NULL,
     parse_verbose_flag, false, true, OPTION_MODE_BINARY},
    ...
    {"palette-chars", 'C', OPTION_TYPE_CALLBACK, offsetof(options_t, palette_custom), "", 0,
     "Custom palette characters (implies --palette=custom)", "DISPLAY", false, "ASCII_CHAT_PALETTE_CHARS", NULL,
     parse_palette_chars, false, false, OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    {"show-capabilities", '\0', OPTION_TYPE_BOOL, offsetof(options_t, show_capabilities),
     &default_show_capabilities_value, sizeof(bool), "Show terminal capabilities and exit", "DISPLAY", false,
    ...
    {"discovery-server-key", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_service_key), "", 0,
     "Discovery server public key for verification (SSH/GPG key or HTTPS URL)", "SECURITY", false,
     "ASCII_CHAT_DISCOVERY_SERVER_KEY", NULL, NULL, false, false, OPTION_MODE_CLIENT | OPTION_MODE_DISCOVERY},
    ...
    {"reconnect-attempts", '\0', OPTION_TYPE_INT, offsetof(options_t, reconnect_attempts),
     ...
     false, "ASCII_CHAT_RECONNECT_ATTEMPTS", NULL, NULL, false, false,
    ...
    {"port-forwarding", '\0', OPTION_TYPE_BOOL, offsetof(options_t, enable_upnp), &default_enable_upnp_value,
     sizeof(bool), "Enable UPnP/NAT-PMP port mapping for direct TCP", "NETWORK", false, "ASCII_CHAT_PORT_FORWARDING",
     NULL, NULL, false, false, OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY_SVC},
    ...
    {"turn-credential", '\0', OPTION_TYPE_STRING, offsetof(options_t, turn_credential), OPT_TURN_CREDENTIAL_DEFAULT, 0,
     "Credential/password for TURN authentication", "NETWORK", false, "ASCII_CHAT_TURN_CREDENTIAL", NULL, NULL, false,
    ...
    {"turn-secret", '\0', OPTION_TYPE_STRING, offsetof(options_t, turn_secret), "", 0,
     "Shared secret for dynamic TURN credential generation (HMAC-SHA1)", "NETWORK", false, "ASCII_CHAT_TURN_SECRET",
    ...
    {"url", 'u', OPTION_TYPE_STRING, offsetof(options_t, media_url), "", 0,
     "Stream from network URL (HTTP/HTTPS/YouTube/RTSP; requires yt-dlp in PATH)", "MEDIA", false, "ASCII_CHAT_URL",
    ...
    {"no-audio-playback", '\0', OPTION_TYPE_BOOL, offsetof(options_t, audio_no_playback),
     &default_no_audio_playback_value, sizeof(bool), "Disable speaker playback", "AUDIO", false,
    ...
    {"database", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_database_path), "", 0,
     "Path to SQLite database for discovery service", "DATABASE", false, "ASCII_CHAT_DATABASE", NULL, NULL, false,
     false, OPTION_MODE_DISCOVERY_SVC},
    {"discovery-server", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_server),
     OPT_ENDPOINT_DISCOVERY_SERVICE, 0, "Discovery service address (for ACDS registration)", "NETWORK", false,
    ...
    {"require-server-identity", '\0', OPTION_TYPE_BOOL, offsetof(options_t, require_server_identity), false,
     sizeof(bool), "ACDS: require servers to provide signed Ed25519 identity", "SECURITY", false,
    ...
    {"require-client-identity", '\0', OPTION_TYPE_BOOL, offsetof(options_t, require_client_identity), false,
     sizeof(bool), "ACDS: require clients to provide signed Ed25519 identity", "SECURITY", false,
