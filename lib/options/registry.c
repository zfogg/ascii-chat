...
static const registry_entry_t g_options_registry[] = {
    ...
    {"log-level", '\0', OPTION_TYPE_CALLBACK, offsetof(options_t, log_level), &default_log_level_value,
     sizeof(log_level_t), "Set log level: dev, debug, info, warn, error, fatal", "LOGGING", false, "ASCII_CHAT_LOG_LEVEL", NULL,
    ...
    {"verbose", 'V', OPTION_TYPE_CALLBACK, offsetof(options_t, verbose_level), 0, sizeof(unsigned short int),
     "Increase log verbosity (stackable: -VV, -VVV, or --verbose)", "LOGGING", false, "ASCII_CHAT_VERBOSE", NULL, parse_verbose_flag,
    ...
    {"webcam-flip", 'g', OPTION_TYPE_BOOL, offsetof(options_t, webcam_flip), &default_webcam_flip_value, sizeof(bool),
     "Flip webcam horizontally", "WEBCAM", false, "ASCII_CHAT_WEBCAM_FLIP", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    ...
    {"palette-chars", 'C', OPTION_TYPE_CALLBACK, offsetof(options_t, palette_custom), "", 0,
     "Custom palette characters (implies --palette=custom)", "DISPLAY", false, "ASCII_CHAT_PALETTE_CHARS", NULL, parse_palette_chars, false,
     false, OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    {"show-capabilities", '\0', OPTION_TYPE_BOOL, offsetof(options_t, show_capabilities),
     &default_show_capabilities_value, sizeof(bool), "Show terminal capabilities and exit", "DISPLAY", false, "ASCII_CHAT_SHOW_CAPABILITIES",
    ...
    {"utf8", '\0', OPTION_TYPE_BOOL, offsetof(options_t, force_utf8), &default_force_utf8_value, sizeof(bool),
     "Force UTF-8 support", "DISPLAY", false, "ASCII_CHAT_UTF8", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    {"stretch", 's', OPTION_TYPE_BOOL, offsetof(options_t, stretch), &default_stretch_value, sizeof(bool),
     "Allow aspect ratio distortion", "DISPLAY", false, "ASCII_CHAT_STRETCH", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    {"strip-ansi", '\0', OPTION_TYPE_BOOL, offsetof(options_t, strip_ansi), &default_strip_ansi_value, sizeof(bool),
     "Strip ANSI escape sequences", "DISPLAY", false, "ASCII_CHAT_STRIP_ANSI", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    ...
    {"encrypt", 'E', OPTION_TYPE_BOOL, offsetof(options_t, encrypt_enabled), &default_encrypt_enabled_value,
     sizeof(bool), "Enable encryption", "SECURITY", false, "ASCII_CHAT_ENCRYPT", NULL, NULL, false, false,
    ...
    {"no-encrypt", '\0', OPTION_TYPE_BOOL, offsetof(options_t, no_encrypt), &default_no_encrypt_value, sizeof(bool),
     "Disable encryption", "SECURITY", false, "ASCII_CHAT_NO_ENCRYPT", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY | OPTION_MODE_DISCOVERY_SVC},
    {"server-key", '\0', OPTION_TYPE_STRING, offsetof(options_t, server_key), "", 0,
     "Expected server public key (client)", "SECURITY", false, "ASCII_CHAT_SERVER_KEY", NULL, NULL, false, false,
    ...
    {"discovery-insecure", '\0', OPTION_TYPE_BOOL, offsetof(options_t, discovery_insecure),
     ...
     "Skip server key verification (MITM-vulnerable, requires explicit opt-in)", "SECURITY", false, "ASCII_CHAT_DISCOVERY_INSECURE", NULL, NULL,
    ...
    {"discovery-server-key", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_service_key), "", 0,
     "Discovery server public key for verification (SSH/GPG key or HTTPS URL)", "SECURITY", false, "ASCII_CHAT_DISCOVERY_SERVER_KEY", NULL, NULL,
     false, false, OPTION_MODE_CLIENT | OPTION_MODE_DISCOVERY},
    ...
    {"max-clients", '\0', OPTION_TYPE_INT, offsetof(options_t, max_clients), &default_max_clients_value, sizeof(int),
     "Maximum concurrent clients (server only)", "NETWORK", false, "ASCII_CHAT_MAX_CLIENTS", NULL, NULL, false, false,
    ...
    {"reconnect-attempts", '\0', OPTION_TYPE_INT, offsetof(options_t, reconnect_attempts),
     ...
     false, "ASCII_CHAT_RECONNECT_ATTEMPTS", NULL, NULL, false, false, OPTION_MODE_CLIENT | OPTION_MODE_DISCOVERY}, // Client and Discovery
    {"port-forwarding", '\0', OPTION_TYPE_BOOL, offsetof(options_t, enable_upnp), &default_enable_upnp_value,
     sizeof(bool), "Enable UPnP/NAT-PMP port mapping for direct TCP", "NETWORK", false, "ASCII_CHAT_PORT_FORWARDING", NULL, NULL, false, false,
    ...
    {"webrtc", '\0', OPTION_TYPE_BOOL, offsetof(options_t, webrtc), &default_webrtc_value, sizeof(bool),
     "Use WebRTC P2P mode (default: Direct TCP)", "NETWORK", false, "ASCII_CHAT_WEBRTC", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY},
    ...
    {"prefer-webrtc", '\0', OPTION_TYPE_BOOL, offsetof(options_t, prefer_webrtc), &default_prefer_webrtc_value,
     sizeof(bool), "Try WebRTC before direct TCP", "NETWORK", false, "ASCII_CHAT_PREFER_WEBRTC", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_DISCOVERY},
    {"webrtc-skip-stun", '\0', OPTION_TYPE_BOOL, offsetof(options_t, webrtc_skip_stun), &default_webrtc_skip_stun_value,
     sizeof(bool), "Skip WebRTC+STUN stage, go straight to TURN relay", "NETWORK", false, "ASCII_CHAT_WEBRTC_SKIP_STUN", NULL, NULL, false,
    ...
    {"stun-servers", '\0', OPTION_TYPE_STRING, offsetof(options_t, stun_servers), OPT_STUN_SERVERS_DEFAULT, 0,
     "Comma-separated list of STUN server URLs", "NETWORK", false, "ASCII_CHAT_STUN_SERVERS", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY_SVC | OPTION_MODE_DISCOVERY},
    {"turn-servers", '\0', OPTION_TYPE_STRING, offsetof(options_t, turn_servers), OPT_TURN_SERVERS_DEFAULT, 0,
     "Comma-separated list of TURN server URLs", "NETWORK", false, "ASCII_CHAT_TURN_SERVERS", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY_SVC | OPTION_MODE_DISCOVERY},
    {"turn-username", '\0', OPTION_TYPE_STRING, offsetof(options_t, turn_username), OPT_TURN_USERNAME_DEFAULT, 0,
     "Username for TURN authentication", "NETWORK", false, "ASCII_CHAT_TURN_USERNAME", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY_SVC | OPTION_MODE_DISCOVERY},
    {"turn-credential", '\0', OPTION_TYPE_STRING, offsetof(options_t, turn_credential), OPT_TURN_CREDENTIAL_DEFAULT, 0,
     "Credential/password for TURN authentication", "NETWORK", false, "ASCII_CHAT_TURN_CREDENTIAL", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY_SVC | OPTION_MODE_DISCOVERY},
    {"turn-secret", '\0', OPTION_TYPE_STRING, offsetof(options_t, turn_secret), "", 0,
     "Shared secret for dynamic TURN credential generation (HMAC-SHA1)", "NETWORK", false, "ASCII_CHAT_TURN_SECRET", NULL, NULL, false,
    ...
    {"url", 'u', OPTION_TYPE_STRING, offsetof(options_t, media_url), "", 0,
     "Stream from network URL (HTTP/HTTPS/YouTube/RTSP)", "MEDIA", false, "ASCII_CHAT_URL", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    ...
    {"seek", 's', OPTION_TYPE_CALLBACK, offsetof(options_t, media_seek_timestamp), &default_media_seek_value,
     sizeof(double), "Seek to timestamp before playback (format: seconds, MM:SS, or HH:MM:SS.ms)", "MEDIA", false, "ASCII_CHAT_SEEK",
    ...
    {"no-cookies-from-browser", '\0', OPTION_TYPE_BOOL, offsetof(options_t, no_cookies_from_browser), false,
     sizeof(bool), "yt-dlp option (man yt-dlp). Explicitly disable reading cookies from browser", "MEDIA", false, "ASCII_CHAT_NO_COOKIES_FROM_BROWSER",
     NULL, NULL, false, false, OPTION_MODE_CLIENT | OPTION_MODE_MIRROR | OPTION_MODE_DISCOVERY},
    ...
    {"no-audio-playback", '\0', OPTION_TYPE_BOOL, offsetof(options_t, audio_no_playback),
     &default_no_audio_playback_value, sizeof(bool), "Disable speaker playback", "AUDIO", false, "ASCII_CHAT_NO_AUDIO_PLAYBACK", NULL, NULL,
     false, false, OPTION_MODE_CLIENT | OPTION_MODE_DISCOVERY},
    ...
    {"database", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_database_path), "", 0,
     "Path to SQLite database for discovery service", "DATABASE", false, "ASCII_CHAT_DATABASE", NULL, NULL, false, false,
     OPTION_MODE_DISCOVERY_SVC},
    {"discovery-server", '\0', OPTION_TYPE_STRING, offsetof(options_t, discovery_server),
     OPT_ENDPOINT_DISCOVERY_SERVICE, 0, "Discovery service address (for ACDS registration)", "NETWORK", false, "ASCII_CHAT_DISCOVERY_SERVER",
    ...
    {"discovery-port", '\0', OPTION_TYPE_INT, offsetof(options_t, discovery_port), &default_discovery_port_value,
     sizeof(int), "Discovery service port", "NETWORK", false, "ASCII_CHAT_DISCOVERY_PORT", NULL, NULL, false, false,
     OPTION_MODE_CLIENT | OPTION_MODE_SERVER | OPTION_MODE_DISCOVERY},
    {"discovery-expose-ip", '\0', OPTION_TYPE_BOOL, offsetof(options_t, discovery_expose_ip),
     ...
     "Allow public IP disclosure in discovery sessions (requires confirmation)", "NETWORK", false, "ASCII_CHAT_DISCOVERY_EXPOSE_IP", NULL, NULL,
    ...
    {"require-server-identity", '\0', OPTION_TYPE_BOOL, offsetof(options_t, require_server_identity), false,
     sizeof(bool), "ACDS: require servers to provide signed Ed25519 identity", "SECURITY", false, "ASCII_CHAT_REQUIRE_SERVER_IDENTITY", NULL, NULL,
    ...
    {"require-client-identity", '\0', OPTION_TYPE_BOOL, offsetof(options_t, require_client_identity), false,
     sizeof(bool), "ACDS: require clients to provide signed Ed25519 identity", "SECURITY", false, "ASCII_CHAT_REQUIRE_CLIENT_IDENTITY", NULL, NULL,
     false, false, OPTION_MODE_DISCOVERY_SVC},
