...
// ============================================================================
// Initialization (calls debug_atomic_register in debug builds)
// ============================================================================
...
#ifndef NDEBUG
    debug_atomic_ptr_register(&a, name);
#endif
...
// ============================================================================
// Destruction (calls debug_atomic_unregister in debug builds)
// ============================================================================

void atomic_destroy(atomic_t *a) {
    if (!a) return;
#ifndef NDEBUG
    debug_atomic_unregister(a);
#endif
}
