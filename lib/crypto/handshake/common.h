 ...
 * @brief Cryptographic handshake common types, enums, and shared functions
 * @ingroup handshake
 * @addtogroup handshake
 * @{
 *
 * This header provides the shared cryptographic handshake types and common functions
