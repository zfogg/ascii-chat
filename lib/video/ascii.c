...
char *ascii_convert_with_capabilities(image_t *original, const ssize_t width, const ssize_t height,
  ...
  STOP_TIMER_AND_LOG(dev, "image_alloc", "IMAGE_ALLOC: Alloc+clear complete (%.2f ms)");
  ...
  STOP_TIMER_AND_LOG(dev, "image_resize", "IMAGE_RESIZE: Resize complete (%.2f ms)");
  ...
  STOP_TIMER_AND_LOG(dev, "image_print_with_capabilities", "IMAGE_PRINT: Print complete (%.2f ms)");
  ...
  STOP_TIMER_AND_LOG(dev, "ascii_padding", "ASCII_PADDING: Padding complete (%.2f ms)");
