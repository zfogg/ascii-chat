...
complete -c ascii-chat -n '__fish_ascii_chat_mode_is client' -l audio-device -x -d 'audio input device index (-1 for default)'
...
complete -c ascii-chat -n '__fish_ascii_chat_mode_is client' -l config -r -d 'load configuration from TOML file'
complete -c ascii-chat -n '__fish_ascii_chat_mode_is client' -l config-create -d 'create default configuration file'
...
complete -c ascii-chat -n '__fish_ascii_chat_mode_is server' -l config -r -d 'load configuration from TOML file'
complete -c ascii-chat -n '__fish_ascii_chat_mode_is server' -l config-create -d 'create default configuration file'
