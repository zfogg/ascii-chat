      ...
      <div className="flex-1 flex flex-col docs-container">
        ...
        <section className="docs-section-spacing">
          ...
          <p className="docs-paragraph">
            ...
            terminal (TTY) or being piped/redirected. This enables clean output
            for scripting:
          </p>
          ...
          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-teal-300 mb-3">Practical Examples</h3>
            <pre className="code-block">
              <code className="code-content">
                {
          ...
          <div className="docs-subsection-spacing">
            ...
            <p className="docs-paragraph">
              ...
              colors are automatically disabled to keep output clean. To capture
              colored snapshots when piping or redirecting, explicitly enable
              colors with <code className="text-cyan-300">--color</code> or{" "}
        ...
        <section className="docs-section-spacing">
          ...
          <p className="docs-paragraph">
            ...
            supports—including YouTube videos, HTTP(S) streaming, RTMP streams,
            and remote video files. Use{" "}
            <code className="text-cyan-300">--url</code> to specify the source
            and <code className="text-cyan-300">--seek</code> to jump to a
            specific timestamp (seek works with files; live streams snapshot the
            current frame):
          </p>
        ...
        <section className="docs-section-spacing">
          ...
          <div className="docs-subsection-spacing">
            ...
            <ul className="space-y-1 text-gray-300 text-sm">
              <li>
                <span className="text-cyan-300">✅ Webcam Access</span> — Webcam
                is working and accessible to ascii-chat
              </li>
              <li>
            ...
            <div className="space-y-3">
              ...
              <div className="card-standard accent-cyan">
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  <code className="text-cyan-300">echo $?</code>. Non-zero means
                  the command failed. Check for error messages in stderr.
                </p>
              </div>
              <div className="card-standard accent-teal">
                <h4 className="text-teal-300 font-semibold mb-2">
          ...
          <div className="space-y-3">
            <div className="card-standard accent-yellow">
              ...
              <p className="text-gray-400 text-xs">
                ...
                <code className="text-cyan-300">yt-dlp</code> to download videos
                first, then snapshot locally. See{" "}
            ...
            <div className="card-standard accent-purple">
              ...
              <p className="text-gray-300 text-sm">
                Generate ASCII art screenshots for README files, presentations,
                blog posts, or web pages. Create unique visual content from
                videos or webcam feeds
              </p>
            </div>
            <div className="card-standard accent-teal">
              <h4 className="text-teal-300 font-semibold mb-2">
              ...
              <p className="text-gray-300 text-sm">
                ...
                connectivity, encryption, and media handling in CI environments
            ...
            <div className="card-standard accent-cyan">
              ...
              <p className="text-gray-300 text-sm">
                ...
                response, or client setup is the problem. Single command checks
                the entire pipeline
              </p>
            </div>
          </div>
