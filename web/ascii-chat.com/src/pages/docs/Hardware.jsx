    ...
    <div className="bg-gray-950 text-gray-100 flex flex-col">
      <div className="flex-1 flex flex-col docs-container">
          ...
          <div className="space-y-3">
            <div className="info-box-info">
              <p className="text-gray-300 text-sm mb-2">
                ...
                <strong>zero mouse interaction support</strong>. All navigation
                and controls are done through keyboard input.
              </p>
            </div>
        ...
        <section className="docs-section-spacing">
          ...
          <div className="docs-subsection-spacing">
            ...
            <p className="docs-paragraph">
              ...
              short form <code className="text-cyan-300">-c</code>) to choose a
              specific camera. (Save it in your{" "}
              <TrackedLink
          ...
          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-pink-300 mb-3">Flip Webcam Video</h3>
            <p className="docs-paragraph">
          ...
          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-green-300 mb-3">Test Pattern Mode</h3>
            <p className="docs-paragraph">
        ...
        <section className="docs-section-spacing">
          ...
          <div className="docs-subsection-spacing">
            ...
            <div className="info-box-info mt-3">
              <p className="text-gray-300 text-sm">
                ...
                mirror modes don't have an <code>--audio</code> flag, but
          ...
          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-cyan-300 mb-3">List Audio Devices</h3>
            <p className="docs-paragraph">
        ...
        <section className="docs-section-spacing">
          ...
          <div className="docs-subsection-spacing">
            ...
            <p className="docs-paragraph">
              Use <code className="text-cyan-300">--cookies-from-browser</code>{" "}
              to handle age-restricted or logged-in content:
            </p>
            <pre className="code-block">
              <code className="code-content">
                {
          ...
          <div className="docs-subsection-spacing">
            ...
            <div className="space-y-3">
              ...
              <div className="card-standard accent-teal">
                <h4 className="text-teal-300 font-semibold mb-2">Space or M</h4>
                <p className="text-gray-300 text-sm">
        ...
        <section className="docs-section-spacing">
          <h2 className="heading-2 text-orange-400">🔗 Option Compatibility</h2>
            ...
            <div className="space-y-3">
              <div className="card-standard accent-orange">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  client mode, required to enable microphone capture. In mirror
                  mode, required to enable audio playback when using --file or
                  --url.
                </p>
              </div>
              ...
              <div className="card-standard accent-orange">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  <code className="text-cyan-300">--speakers-volume</code>, and{" "}
                  <code className="text-cyan-300">--audio-source</code> work in
                  all modes.
                </p>
              </div>
              ...
              <div className="card-standard accent-orange">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  <code className="text-cyan-300">--url</code> not available in
                  server or discovery-service modes.
                </p>
              </div>
              ...
              <div className="card-standard accent-orange">
                ...
                <p className="text-gray-300 text-sm">
                  <strong>Client & Mirror Only:</strong> Render modes, palettes,
                  FPS, and snapshot only work in client and mirror modes.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="card-standard accent-yellow">
                ...
                <p className="text-gray-300 text-sm mb-2">
                  ...
                  <code className="text-cyan-300">--url</code> takes precedence
                  over webcam
                </p>
              </div>
          ...
          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-teal-300 mb-3">Audio Dependencies</h3>
            <div className="space-y-3">
              <div className="card-standard accent-teal">
                ...
                <p className="text-gray-300 text-sm">
                  In <strong>mirror mode:</strong> No--audio flag needed. Audio
                  volume controls still apply.
                </p>
              </div>
...
ascii-chat client --audio -m -1 --speakers-index 1`}
        ...
        <section className="docs-section-spacing">
          ...
          <div className="docs-subsection-spacing">
            ...
            <div className="space-y-3">
              ...
              <div className="card-standard accent-cyan">
                <h4 className="text-cyan-300 font-semibold mb-2">With Audio</h4>
                <pre className="code-block text-xs">
                  <code className="code-content">
                    ascii-chat client example.com --audio
                  </code>
  ...
  --microphone-volume 0.5 --speakers-volume 0.5`}
          ...
          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-purple-300 mb-3">Troubleshooting</h3>
            <div className="space-y-3">
              <div className="card-standard accent-purple">
                <h4 className="text-purple-300 font-semibold mb-2">
                  Webcam Not Found
                ...
                <ol className="list-decimal list-inside text-gray-300 text-sm space-y-1">
                  <li>
                    Run <code className="text-cyan-300">--list-webcams</code> to
                    see all devices
                  </li>
                  <li>Check that device index matches what you're using</li>
                  <li>
                    Try <code className="text-cyan-300">--test-pattern</code> to
                    verify ascii-chat works
                  </li>
                  <li>
              ...
              <div className="card-standard accent-purple">
                <h4 className="text-purple-300 font-semibold mb-2">No Audio</h4>
              ...
              <div className="card-standard accent-purple">
                ...
                <ul className="list-disc list-inside text-gray-300 text-sm space-y-1">
                  <li>Ensure ffmpeg is installed (used for format support)</li>
