    ...
    <>
      ...
      <div className="bg-gray-950 text-gray-100 flex flex-col">
        <div className="flex-1 flex flex-col docs-container">
          ...
          {/* Webcam Setup */}
          <section className="docs-section-spacing">
            <Heading level={2} className="heading-2 text-purple-400">🎬 Webcam Setup</Heading>
          ...
          {/* Audio Setup */}
          <section className="docs-section-spacing">
            <Heading level={2} className="heading-2 text-teal-400">🎙️ Audio Setup</Heading>
          ...
          {/* Media Streaming */}
          <section className="docs-section-spacing">
            <Heading level={2} className="heading-2 text-indigo-400">🎥 Media Streaming</Heading>
            ...
            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-blue-300 mb-3">Stream from URLs</Heading>
              <p className="docs-paragraph">
            ...
            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-cyan-300 mb-3">Playback Control</Heading>
              <CodeBlock language="bash">
                {
          ...
          {/* Display Options */}
          <section className="docs-section-spacing">
            <Heading level={2} className="heading-2 text-yellow-400">🎨 Display Options</Heading>

            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-yellow-300 mb-3">Render Modes</Heading>
              <p className="docs-paragraph">
            ...
            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-purple-300 mb-3">ASCII Palettes</Heading>
              <p className="docs-paragraph">
            ...
            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-teal-300 mb-3">Aspect Ratio</Heading>
              <CodeBlock language="bash">
                {
          ...
          {/* Keyboard Shortcuts */}
          <section className="docs-section-spacing">
            <Heading level={2} className="heading-2 text-green-400">⌨️ Keyboard Shortcuts</Heading>
            ...
            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-green-300 mb-3">Video & Effects</Heading>
              <div className="space-y-3">
...
ascii-chat client --audio -m -1 --speakers-index 1`}
          ...
          {/* Tips & Tricks */}
          <section className="docs-section-spacing">
            <Heading level={2} className="heading-2 text-blue-400">💡 Tips & Tricks</Heading>

            <div className="docs-subsection-spacing">
              <Heading level={3} className="heading-3 text-blue-300 mb-3">Device Discovery</Heading>
              <CodeBlock language="bash">
                {
