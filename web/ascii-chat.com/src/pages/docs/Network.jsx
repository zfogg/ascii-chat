  ...
  return (
    <>
      <AsciiChatHead
        ...
        url="https://ascii-chat.com/docs/network"
      />
        ...
        <div className="flex-1 flex flex-col docs-container">
          ...
          <section className="docs-section-spacing">
            ...
            <p className="docs-paragraph">
              ...
              <code className="code-inline">purple-mountain-lake</code>). No
              port forwarding, no technical knowledge required. When you run the
              server without specifying a connection mode, it automatically
              generates a session string and registers with the discovery
              service. Clients connect using that session string. The official
              ascii-chat discovery-service is hosted at{" "}
