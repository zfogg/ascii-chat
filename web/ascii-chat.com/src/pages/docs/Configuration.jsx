      ...
      <div className="flex-1 flex flex-col docs-container">
        ...
        <section className="docs-section-spacing">
          ...
          <div className="info-box-note">
            ...
            <p className="text-gray-400 text-sm">
              Built-in default:{" "}
              <code className="text-cyan-300">port = 27224</code> → Config file:{" "}
              <code className="text-cyan-300">port = 8080</code> → Env var:{" "}
              <code className="text-cyan-300">ASCII_CHAT_PORT=9000</code> → CLI
              flag: <code className="text-cyan-300">--port 9999</code> =
...
log_file = "/tmp/ascii-chat.log"`}</code>
        ...
        {/* Environment Variables */}
        <section className="docs-section-spacing">
          <h2 className="heading-2 text-cyan-400">🌍 Environment Variables</h2>
          ...
          <div className="docs-subsection-spacing">
            ...
            <p className="text-gray-400 text-sm mb-3">
              ...
              Environment variables provide session-wide configuration that can
              be overridden by explicit CLI flags. For a complete list of all
              available <code className="text-cyan-300">ASCII_CHAT_*</code>{" "}
              variables, see the{" "}
            ...
            <div className="space-y-3">
              <div className="card-standard accent-pink">
                ...
                <p className="text-gray-400 text-sm mt-3">
                  View <code className="text-cyan-300">man ascii-chat</code> or
                  the <code className="text-cyan-300">ascii-chat(1)</code>{" "}
...
`}</code>
          ...
          <div className="docs-subsection-spacing">
            ...
            <div className="space-y-3">
              ...
              <div className="card-standard accent-purple">
                ...
                <p className="text-gray-400 text-sm">
                  Defaults to <code className="text-cyan-300">~/.gnupg</code> if
                  not set
                </p>
              </div>
              <div className="card-standard accent-purple">
        ...
        <section className="docs-section-spacing">
          ...
          <p className="docs-paragraph">
            ...
            a traditional Unix man page. It contains the full list of all
            options, environment variables, examples, security details, and
            more.
          </p>

          <div className="docs-subsection-spacing">
            <h3 className="heading-3 text-teal-300 mb-4">View the Man Page</h3>
            <p className="text-gray-400 text-sm mb-3">
...
export MANPATH="$(brew --prefix)/share/man:$MANPATH"`}</code>
            ...
            <div className="docs-subsection-spacing">
              ...
              <p className="text-gray-400 text-sm mb-2">
                ...
                usually in your <code className="text-cyan-300">MANPATH</code>{" "}
                by default.
              </p>
              <p className="text-gray-400 text-sm">
