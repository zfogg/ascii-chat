      ...
      <div className="space-y-6">
        <div className="bg-gray-900/50 border border-pink-900/30 rounded-lg p-4 sm:p-6">
          ...
          <p className="text-gray-300 mb-3">
            HTTPS can rely on Certificate Authorities because there's a globally
            trusted PKI. ascii-chat has no such infrastructure for raw TCP
            connections. Yet users need both{" "}
            <strong className="text-cyan-300">privacy</strong> (against passive
            eavesdropping) and{" "}
          ...
          <p className="text-gray-300">
            ...
            where users choose their trust level based on their threat model.
          </p>
        </div>
        ...
        <div className="bg-gray-900/50 border border-purple-900/30 rounded-lg p-6">
          ...
          <div className="space-y-3 text-gray-300">
            <div className="bg-gray-950/50 border border-cyan-900/30 rounded p-3">
              ...
              <br />
              Ephemeral keys, no identity verification. Protects against passive
              eavesdropping. Works out-of-the-box with zero configuration.
            ...
            <div className="bg-gray-950/50 border border-purple-900/30 rounded p-3">
              ...
              <em>bound to the DH shared secret</em>. Prevents MITM attacks even
              without pre-shared keys.
            </div>
            ...
            <div className="bg-gray-950/50 border border-pink-900/30 rounded p-3">
              ...
              <br />
              Servers can enforce authorized client key list. Only pre-approved
              clients can connect. Clients can authorize the key of the server
              they're connecting to and will refuse to connect if there's a
              mismatch.
            </div>
            <div className="bg-gray-950/50 border border-cyan-900/30 rounded p-3">
        ...
        <div className="bg-gray-900/50 border border-cyan-900/30 rounded-lg p-6">
          ...
          <p className="text-gray-300 mt-3">
            ACDS only sees connection metadata (session strings, public keys,
            ICE candidates). Your video and audio flow peer-to-peer with
            end-to-end encryption. ACDS never touches your media.
          </p>
          <div className="bg-cyan-900/20 border border-cyan-700/50 rounded-lg p-4 mt-4">
            <p className="text-gray-300 text-sm">
              <strong className="text-cyan-300">Note:</strong> For complete ACDS
              public key information and fingerprints, visit{" "}
              <TrackedLink
        ...
        <div className="bg-gray-900/50 border border-teal-900/30 rounded-lg p-6">
          ...
          <ul className="space-y-3 text-gray-300">
            <li>
              <strong className="text-cyan-400">libsodium over OpenSSL:</strong>{" "}
              Smaller attack surface, better defaults, fixed key sizes simplify
              protocol design. No misconfiguration pitfalls.
            </li>
            <li>
              <strong className="text-purple-400">
            ...
            <li>
              ...
              Ed25519 proves "who you are," X25519 provides "forward secrecy."
              Even if long-term key is compromised, past sessions remain secret.
            </li>
            <li>
              <strong className="text-pink-400">Session rekeying:</strong>{" "}
              Limits impact of key compromise. Automatic rotation after 1 hour
              or 1 million packets—whichever comes first.
            </li>
            <li>
        ...
        <div className="bg-purple-900/20 border border-purple-700/50 rounded-lg p-6">
          ...
          <p className="text-gray-300">
            You can mix and match verification methods. Password-only for quick
            sessions. SSH keys for stronger identity. ACDS for zero-config.
            Stack all three if you want. More verification = stronger security,
            but defaults work without configuration.
          </p>
        </div>
      </div>
    </section>
