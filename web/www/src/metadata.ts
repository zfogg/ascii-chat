...
export const pageMetadata = {
  ...
  man1: {
    title: "ascii-chat(1) - ascii-chat Manual",
    description:
      "Complete man page for the ascii-chat binary with all command-line options, modes, and examples.",
  },
  man5: {
    title: "ascii-chat(5) - Configuration Files",
    description:
      "Man page for ascii-chat configuration file format and syntax.",
  },
  man3: {
    title: "ascii-chat API Documentation",
    description:
      "Source code documentation for ascii-chat and libasciichat libraries. Browse structs, functions, and file references.",
  },
  notFound: {
    title: "Page Not Found - ascii-chat",
    description:
      "The page you're looking for doesn't exist. Return to the homepage or browse the documentation.",
  },
};
