          ...
          <div className="flex-1 flex flex-col docs-container">
            ...
            <section className="docs-section-spacing">
              ...
              <div className="space-y-3">
                ...
                <div className="info-box-note">
                  <p className="text-gray-300 text-sm mb-2">
                    <strong>🌐 UTF-8 & Unicode:</strong> Automatically detected
                    by locale. Use <code>--utf8</code> to override. Some render
                    modes (half-block, blocks) require UTF-8 support.
                  </p>
                </div>

                <div className="info-box-note">
                  <p className="text-gray-300 text-sm mb-2">
                    <strong>📦 Piping & Redirection:</strong> When output is
                    piped (e.g., <code>ascii-chat mirror | tee file.txt</code>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="info-box-info mt-3">
                  <p className="text-gray-300 text-sm">
                    <strong>When colors are disabled:</strong> Display switches
                    to monochrome (black and white). Piping automatically
                    disables colors unless <code>--color true</code> is used.
                  </p>
                </div>
              </div>
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Control how many colors are available (when colors are
                  enabled). Default is <code>auto</code>, which detects your
                  terminal's capability. (Save these in your{" "}
                  <TrackedLink
                ...
                <div className="space-y-2 mt-3">
                  <div className="card-standard accent-purple">
                    ...
                    <ul className="list-disc list-inside text-gray-300 text-sm space-y-1">
                      ...
                      <li>
                        <strong>truecolor:</strong> Full 24-bit RGB color
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Control the color scheme for ascii-chat's debug/log output
                  (not video display):
                </p>
                <CodeBlock language="bash">
                  {
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  characters are ~2:1 height:width). Use <code>--stretch</code>{" "}
                  to ignore aspect ratio and fill the terminal:
                </p>
                <CodeBlock language="bash">
                  {
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="info-box-info mt-3">
                  <p className="text-gray-300 text-sm">
                    <strong>Auto-Update:</strong> When running interactively
                    (not piped), dimensions are updated in real-time when you
                    resize the terminal.
                  </p>
                </div>
              </div>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Control UTF-8/Unicode character support for palettes and
                  output:
                </p>
                <CodeBlock language="bash">
                  {
                ...
                <div className="info-box-warning mt-3">
                  <p className="text-gray-300 text-sm">
                    ...
                    half-block) require UTF-8. They'll fall back to ASCII if
                    UTF-8 is disabled.
                  </p>
                </div>
              </div>
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Remove ANSI escape sequences from output (for saving to files
                  or processing text):
                </p>
                <CodeBlock language="bash">
                  {
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Output includes: color support, Unicode support, terminal
                  size, isatty status, environment variables, and detected TERM
                  type.
                </p>
              </div>
