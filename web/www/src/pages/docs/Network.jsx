          ...
          <div className="flex-1 flex flex-col docs-container">
            <header className="mb-12 sm:mb-16">
              <Heading level={1} className="heading-1 mb-4">
                <span className="text-green-400">🌐</span> Network & ACIP
                Protocol
              </Heading>
              <p className="text-lg sm:text-xl text-gray-300">
                ACIP protocol architecture, ACDS discovery, NAT traversal, and
                P2P connections
              </p>
            </header>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ACIP (ascii-chat Internet Protocol) is a custom binary
                  protocol designed specifically for low-latency, encrypted
                  terminal-based video conferencing. Unlike HTTP, RTP, RTSP, or
                  VNC, ACIP is optimized for:
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="card-standard accent-orange">
                    ...
                    <p className="text-gray-400 text-sm mb-3">
                      ...
                      encryption keys are established. Uses X25519 (ECDH) for
                      key agreement and Ed25519 for authentication. For detailed
                  ...
                  <div className="card-standard accent-violet">
                    ...
                    <p className="text-gray-400 text-sm">
                      <code className="code-inline">1200</code> =
                      PACKET_ENCRYPTED
                      <br />
                      ...
                      <br />
                      Empty packet encrypted with NEW key (signals rekey
                      complete)
                    </p>
                  </div>
                  ...
                  <div className="card-standard accent-cyan">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      (Client → Server)
                      <br />
                      RGB image data with dimensions. Auto-compressed with zstd
                      if exceeds 16KB
                    </p>
                  </div>
                  ...
                  <div className="card-standard accent-yellow">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      <br />
                      <br />
                      <code className="code-inline">4001</code> =
                      AUDIO_OPUS_BATCH
                      <br />
                  ...
                  <div className="card-standard accent-green">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      <br />
                      <br />
                      <code className="code-inline">5001</code> = PING
                      (Keepalive)
                      <br />
                      Low-latency connectivity check (typically ~5s interval)
                      <br />
                      <br />
                      <code className="code-inline">5002</code> = PONG
                      (Keepalive response)
                      <br />
                  ...
                  <div className="card-standard accent-teal">
                    ...
                    <p className="text-gray-400 text-sm mb-3">
                      ...
                      <br />
                      <br />
                      <code className="code-inline">6007</code> =
                      ACIP_SESSION_END (Host → ACDS)
                      <br />
                    ...
                    <p className="text-gray-400 text-sm mb-3">
                      <code className="code-inline">6009</code> =
                      ACIP_WEBRTC_SDP (Bidirectional)
                      <br />
                      Session Description Protocol (offer/answer)
                      <br />
                      <code className="code-inline">6010</code> =
                      ACIP_WEBRTC_ICE (Bidirectional)
                      <br />
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      <br />
                      <br />
                      <code className="code-inline">6199</code> = ACIP_ERROR
                      (ACDS → Client)
                      <br />
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Frames use zstd compression (configurable levels 1-9) to
                  reduce bandwidth. Large frames are automatically compressed.
                  RLE (Run-Length Encoding) optimizes identical pixels.
                </p>
              </div>
            </section>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Each session uses ephemeral X25519 keys that are discarded
                  after use. Even if long-term keys are compromised, past
                  sessions cannot be decrypted. Periodic key rotation for
            ...
            <section className="docs-section-spacing">
              ...
              <p className="docs-paragraph">
                ...
                zero-config P2P video calls using memorable session strings
                (e.g., <code className="code-inline">purple-mountain-lake</code>
                ...
                discovery service. Clients connect using that session string.
                The official ascii-chat discovery-service is hosted at{" "}
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Two participants exchange NAT information and instantly elect
                  a host. No bandwidth test blocking media startup.
                </p>
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  participants begin capturing. No connection reset on
                  migration.
                </p>
              </div>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ascii-chat Discovery Service (ACDS) is a rendezvous server
                  that helps clients find each other using memorable session
                  strings. ACDS attempts NAT traversal (UPnP, STUN, TURN) and
                  provides connection metadata. Crucially:{" "}
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Format:{" "}
                  <code className="code-inline">adjective-noun-noun</code>
                </p>
                <CodeBlock language="bash">
                  {
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  ACDS. The session string is auto-generated and printed when
                  the server starts:
                </p>
                <CodeBlock language="bash">
                  {
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Works on ~70% of home routers. Automatic port forwarding
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  <br />
                  <strong>TURN:</strong> Relay fallback (works in 99% of
                  networks, slightly higher latency)
                </p>
              </div>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="space-y-3">
                ...
                <div className="card-standard accent-cyan">
                  ...
                  <p className="text-gray-300 text-sm">
                    Reduce frame rate:{" "}
                    <code className="code-inline">--fps 20</code>. Disable
                    audio:
                    <code className="code-inline">--no-audio</code>. Enable
                    lower color mode:{" "}
                    <code className="code-inline">--color-mode 16</code>.
                  </p>
                </div>
                <div className="card-standard accent-purple">
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    (highest latency). Typical on corporate networks. Try:
                    enable UPnP on your router, or use the same physical
                    network.
                  </p>
                </div>
              </div>
