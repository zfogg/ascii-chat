          ...
          <div className="flex-1 flex flex-col docs-container">
            <header className="mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300">
                Config files, locations, overrides, options, and shell
                completions
              </p>
            </header>
            ...
            <section className="docs-section-spacing">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        ...
                        <code className="text-gray-300">--port 8080</code>).
                        Most explicit and immediate input.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="info-box-note">
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  var:{" "}
                  <code className="text-cyan-300">ASCII_CHAT_PORT=9000</code> →
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="text-gray-400 text-sm mb-3">
                  Searched in order (first found is used, remaining are
                  skipped):
                </p>
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="text-gray-400 text-sm mb-3">
                  Generate a template config file with all options commented
                  out:
                </p>
                <CodeBlock language="bash">
                  {
            ...
            <section className="docs-section-spacing">
              ...
              <p className="docs-paragraph">
                Configuration files use <strong>TOML format</strong>. Each
                section in the config file corresponds to a section in{" "}
                ...
                <div className="space-y-3">
                  <div className="card-standard accent-green">
                    ...
                    <p className="text-gray-400 text-sm mb-2">
                      Each <code className="text-cyan-300">[section]</code> in
                      the config corresponds to a section from{" "}
...
log_file = "/tmp/ascii-chat.log"`}</CodeBlock>
              ...
              <p className="docs-paragraph text-sm mt-4 text-gray-400">
                <strong>Tip:</strong> Only include the sections and keys you
                want to customize. All unspecified options use built-in
                defaults. See{" "}
            ...
            <section className="docs-section-spacing">
              ...
              <p className="docs-paragraph">
                ...
                <strong>(1)</strong> overriding option values (when not
                overridden by CLI flags), and <strong>(2)</strong> discovering
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="text-gray-400 text-sm mb-3">
                  ...
                  can be overridden by explicit CLI flags. For a complete list
                  of all available{" "}
                ...
                <div className="space-y-3">
                  <div className="card-standard accent-pink">
                    ...
                    <p className="text-gray-400 text-sm mt-3">
                      ...
                      or the{" "}
                      <code className="text-cyan-300">ascii-chat(1)</code>{" "}
                      documentation for the complete list of all supported
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="space-y-3">
                  <div className="card-standard accent-purple">
                    ...
                    <p className="text-gray-400 text-sm mb-2">
                      SSH agent socket for password-free key authentication
                      (Unix only)
                    </p>
                    <p className="text-gray-400 text-sm">
                  ...
                  <div className="card-standard accent-purple">
                    ...
                    <p className="text-gray-400 text-sm">
                      Defaults to{" "}
                      <code className="text-cyan-300">~/.gnupg</code> if not set
                    </p>
                  </div>
                  <div className="card-standard accent-purple">
                    <Heading
                  ...
                  <div className="card-standard accent-purple">
                    ...
                    <p className="text-gray-400 text-sm">
                      Defaults to{" "}
                      <code className="text-cyan-300">~/.local/share</code> if
                      not set
                    </p>
                  </div>
                  <div className="card-standard accent-purple">
...
open https://ascii-chat.com/man5  # File formats`}
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  By default, the ascii-chat man page is installed in the
                  standard system location. If{" "}
...
export MANPATH="$(brew --prefix)/share/man:$MANPATH"`}</CodeBlock>
                ...
                <div className="docs-subsection-spacing">
                  ...
                  <p className="text-gray-400 text-sm mb-2">
                    ...
                    <code className="text-cyan-300">/usr/local/share/man</code>{" "}
                    or <code className="text-cyan-300">/usr/share/man</code>.
                    These are usually in your{" "}
              ...
              <div className="info-box-info mt-4">
                <p className="text-gray-300 text-sm">
                  ...
                  <code className="text-cyan-300">ASCII_CHAT_*</code>{" "}
                  variables), EXAMPLES, SECURITY, KEYBOARD CONTROLS, and more.
                </p>
              </div>
            </section>
