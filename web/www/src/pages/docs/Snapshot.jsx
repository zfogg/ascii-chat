        ...
        <div className="bg-gray-950 text-gray-100 flex flex-col">
          <div className="flex-1 flex flex-col docs-container">
            ...
            <section className="docs-section-spacing">
              ...
              <p className="docs-paragraph">
                ascii-chat automatically detects whether stdout is connected to
                a terminal (TTY) or being piped/redirected. This enables clean
                ...
                <div className="space-y-3">
                  <div className="card-standard accent-cyan">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      codes, cursor movement, and terminal optimizations for
                      live display
                    </p>
                  </div>
                  <div className="card-standard accent-teal">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      automatically outputs clean ASCII without ANSI codes,
                      cursor movement, or RLE compression
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  By default, colors are only enabled when stdout is connected
                  to a terminal. When piping or redirecting (when{" "}
                  <code className="text-cyan-300">isatty()</code> returns
                  false), colors are automatically disabled to keep output
                  clean. To capture colored snapshots when piping or
                  redirecting, explicitly enable colors with{" "}
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  waits 4 seconds to allow webcam adjustment. For faster
                  captures:
                </p>
                <CodeBlock language="bash">
                  {
              ...
              <div className="docs-subsection-spacing">
                <div className="info-box-warning">
                  ...
                  <p className="text-gray-400 text-sm">
                    <strong>Solution:</strong> Use at least 3-4 seconds of
                    warmup time. The default 4 seconds is optimal for most macOS
                    cameras. If you consistently get black frames, increase to{" "}
            ...
            <section className="docs-section-spacing">
              ...
              <p className="docs-paragraph">
                ...
                <code className="text-cyan-300">--url</code> to specify the
                source and <code className="text-cyan-300">--seek</code> to jump
                to a specific timestamp (seek works with files; live streams
              ...
              <div className="docs-subsection-spacing">
                ...
                <ul className="space-y-1 text-gray-300 text-sm">
                  ...
                  <li>
                    ...
                    — Discovery service lookup, NAT traversal, and peer
                    connection all worked
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-3">
                  <div className="card-standard accent-pink">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      <code className="text-cyan-300">-D 3</code> or higher.
                      macOS hardware needs time to warm up.
                    </p>
                  </div>
                  <div className="card-standard accent-cyan">
                    <Heading
                  ...
                  <div className="card-standard accent-teal">
                    ...
                    <p className="text-gray-400 text-sm">
                      ...
                      <code className="text-cyan-300">--color-mode mono</code>{" "}
                      or <code className="text-cyan-300">--color false</code> to
                  ...
                  <div className="card-standard accent-purple">
                    ...
                    <p className="text-gray-400 text-sm mb-2">
                      <strong>Problem:</strong> Client snapshot hangs or times
              ...
              <div className="space-y-3">
                <div className="card-standard accent-yellow">
                  ...
                  <p className="text-gray-300 text-sm mb-2">
                    Capture ASCII art frames from any media source—YouTube
                    videos, HTTP(S) files, RTMP live streams, and more. Use{" "}
                ...
                <div className="card-standard accent-green">
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    palettes and dimensions. Process entire directories or
                    create frame sequences for animation
                  </p>
                </div>
                <div className="card-standard accent-purple">
                  <Heading
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    presentations, blog posts, or web pages. Create unique
                    visual content from videos or webcam feeds
                  </p>
                </div>
                <div className="card-standard accent-teal">
                  <Heading
