        ...
        <div className="flex-1 flex flex-col docs-container">
          ...
          <section className="docs-section-spacing">
            ...
            <div className="space-y-3">
              ...
              <div className="card-standard accent-teal">
                <Heading level={4} className="text-teal-300 font-semibold mb-2">Scaling</Heading>
                <p className="text-gray-300 text-sm mb-2">
              ...
              <div className="card-standard accent-orange">
                <Heading level={4} className="text-orange-300 font-semibold mb-2">Palettes</Heading>
                <p className="text-gray-300 text-sm mb-2">
              ...
              <div className="card-standard accent-pink">
                <Heading level={4} className="text-pink-300 font-semibold mb-2">Seeking</Heading>
                <p className="text-gray-300 text-sm mb-2">
          ...
          <section className="docs-section-spacing">
            ...
            <div className="space-y-3">
              ...
              <div className="card-standard accent-green">
                <Heading level={4} className="text-green-300 font-semibold mb-2">CPU Usage</Heading>
                <p className="text-gray-400 text-sm">
