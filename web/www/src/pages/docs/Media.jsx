          ...
          <div className="flex-1 flex flex-col docs-container">
            <header className="mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300">
                Stream local files, remote URLs, live streams, and piped media
                as ASCII art
              </p>
            </header>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ASCII art rendering supports any video container and codec
                ...
                <div className="space-y-3">
                  <div className="card-standard accent-cyan">
                    ...
                    <p className="text-gray-400 text-sm">
                      MP4, WebM, MKV, MOV, AVI, FLV, 3GP, WMV, TS, M2TS, MTS,
                      and more
                    </p>
                  </div>
                  <div className="card-standard accent-teal">
                    ...
                    <p className="text-gray-400 text-sm">
                      H.264, H.265 (HEVC), VP8, VP9, AV1, MPEG-2, MPEG-4,
                      Theora, and more
                    </p>
                  </div>
            ...
            <section className="docs-section-spacing">
              ...
              <p className="docs-paragraph">
                ...
                downloading streams. For detailed information on supported
                formats and codecs, see{" "}
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Display and process individual images. Supports PNG, JPEG,
                  WebP, BMP, TIFF, and more:
                </p>
                <CodeBlock language="bash">
                  {
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Jump to specific timestamps in videos, audio, and streaming
                  URLs using seconds:
                </p>
                <CodeBlock language="bash">
                  {
              ...
              <div className="space-y-3">
                <div className="card-standard accent-cyan">
                  ...
                  <p className="text-gray-300 text-sm mb-2">
                    <code className="code-inline">--fps N</code> Set target
                    frame rate (default: 30)
                  </p>
                  <p className="text-gray-400 text-xs">
                    Example: <code className="code-inline">--fps 60</code> for
                    smooth playback,{" "}
                    <code className="code-inline">--fps 10</code> for
                ...
                <div className="card-standard accent-purple">
                  ...
                  <p className="text-gray-300 text-sm mb-2">
                    <code className="code-inline">--audio</code> Enable audio
                    from media file
                  </p>
                  <p className="text-gray-400 text-xs">
                ...
                <div className="card-standard accent-teal">
                  ...
                  <p className="text-gray-300 text-sm mb-2">
                    <code className="code-inline">--width, --height</code>{" "}
                    Control display dimensions
                  </p>
                  <p className="text-gray-400 text-xs">
                    Example:{" "}
              ...
              <div className="space-y-3">
                <div className="card-standard accent-cyan">
                  ...
                  <p className="text-gray-300 text-sm">
                    Stream movies as ASCII art during development sessions or as
                    a novelty. Works over SSH for remote viewing.
                  </p>
                </div>
                <div className="card-standard accent-green">
                  <Heading
                ...
                <div className="card-standard accent-orange">
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    <code className="code-inline">--seek</code> for specific
                    clips
                  </p>
                </div>
                <div className="card-standard accent-pink">
                ...
                <div className="card-standard accent-yellow">
                  ...
                  <p className="text-gray-300 text-sm">
                    Pipe FFmpeg processing chains for automated video analysis
                    or real-time monitoring dashboards in the terminal
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="space-y-3">
                ...
                <div className="card-standard accent-purple">
                  ...
                  <p className="text-gray-400 text-sm">
                    Typical usage: monochrome at 10 fps ≈ 10-20 Kbps, truecolor
                    at 30 fps ≈ 200-500 Kbps. Add audio for +50-100 Kbps.
                  </p>
                </div>
                <div className="card-standard accent-green">
                  <Heading
