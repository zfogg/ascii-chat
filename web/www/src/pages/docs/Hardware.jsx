          ...
          <div className="flex-1 flex flex-col docs-container">
              ...
              <div className="space-y-3">
                ...
                <div className="info-box-note">
                  <p className="text-gray-300 text-sm mb-2">
                    ...
                    <code className="text-cyan-300">--list-*</code> commands
                    start at 0. Use <code className="text-cyan-300">-1</code>{" "}
                    for microphones and speakers to select the system default
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  short form <code className="text-cyan-300">-c</code>) to
                  choose a specific camera. (Save it in your{" "}
                  <TrackedLink
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Control horizontal and vertical mirroring of webcam output
                  with <code className="text-cyan-300">--flip-x</code> and{" "}
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Use a test pattern instead of actual webcam (useful for
                  testing, CI/CD, or when no camera is available):
                </p>
                <CodeBlock language="bash">
                  {
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="info-box-info mt-3">
                  <p className="text-gray-300 text-sm">
                    ...
                    and mirror modes don't have an <code>--audio</code> flag,
                    but support audio volume and source controls.
                  </p>
                </div>
              </div>
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="info-box-info mt-3">
                  <p className="text-gray-300 text-sm">
                    <strong>Works in:</strong> client mode (with --audio),
                    mirror mode, and server mode
                  </p>
                </div>
              </div>
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  ...
                  <code className="text-cyan-300">-f</code> to stream from
                  video, audio, or image files (also supports stdin with{" "}
              ...
              <div className="docs-subsection-spacing">
                ...
                <p className="docs-paragraph">
                  Use{" "}
                  <code className="text-cyan-300">--cookies-from-browser</code>{" "}
            ...
            <section className="docs-section-spacing">
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="info-box-info mt-3">
                  <p className="text-gray-300 text-sm">
                    <strong>Half-Block Mode:</strong> Provides twice the
                    vertical resolution by using Unicode block characters. Great
                    for detailed images or when you want smaller ASCII art.
                  </p>
                </div>
              </div>
              ...
              <div className="docs-subsection-spacing">
                ...
                <div className="info-box-note mt-3">
                  <p className="text-gray-300 text-sm">
                    <strong>Custom Palette:</strong> Characters should be
                    ordered from darkest to brightest. More characters = more
                    detail.
                  </p>
                </div>
              </div>
