              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="bg-gray-900/50  rounded-lg p-4 sm:p-6">
                  ...
                  <p className="text-gray-300">
                    ...
                    and audio never leave the secure tunnel between peers. SSH
                    and GPG key supported. GitHub and GitLab integrations.
                  </p>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-900/50  rounded-lg p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    ...
                    Internet Protocol) for encrypted peer-to-peer video and
                    audio streaming.{" "}
                    <TrackedLink
                      to="/man3"
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-300 mb-4 ml-4">
                    ...
                    <li>
                      <strong className="text-pink-400">Network:</strong> TCP,
                      NAT traversal, WebRTC ICE, ACDS
                    </li>
                    <li>
